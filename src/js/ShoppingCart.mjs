...
export default class ShoppingCart {
  ...
  // This function retrieves cart items from local storage and renders them on the page
  renderCartContents() {
  ...
  // This function generates the HTML for a given cart item
  ...
  // listeners to remove item buttons
